...
final class CustomMessagesNavigationBarView: UIView {
    ...
    fileprivate lazy var backButton = UIButton(image: #imageLiteral(resourceName: "back"), tintColor: #colorLiteral(red: 0.9704898391, green: 0.009552962224, blue: 0.3605019813, alpha: 1))
